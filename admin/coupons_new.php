...
?>
	...
	<center>
		<a href="admin_new.php?action=coupons&page=new">Add New</a> | 
		<a href="admin_new.php?action=coupons&sort=active&schoolid=<?php echo $schoolid ?>">View Live Coupons</a> | 
		<a href="admin_new.php?action=coupons&sort=pending&schoolid=<?php echo $schoolid ?>">View client Update Pending coupons</a> | 
		<a href="admin_new.php?action=coupons&sort=inactive&schoolid=<?php echo $schoolid ?>">Admin Approval Awaiting Coupons</a> | 
		<a href="admin_new.php?action=coupons&sort=expired&schoolid=<?php echo $schoolid ?>">Past-Due/Expired Coupons</a>
	</center>
	<?
