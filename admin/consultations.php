...
if($_POST['subaction'] == "active")
{
	...
	{
		$select = "update consultations set status=1 WHERE id='$k'";
...
<?
	...
	<tr>
		...
		<input type=submit value='Archive' onclick=fun_redirect('1')>
		</td><td colspan='5'><input type=submit value='Delete' onclick=fun_redirect('2')><td>
	</tr>
	";
	echo "</table></form>";
...
<script type="text/javascript">
 function fun_consultant_sort(fieldname,setorder){
 	...
 	window.location="https://www.universityvalues.com/MW/admin.php?action=consultations&sort_fname="+fieldname+"&sort_order="+neworder;
 }	
