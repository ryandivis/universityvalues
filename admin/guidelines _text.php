...
$update="update managepages set page_name='$descr.' where id='3' ";
$resultudate=mysql_query($update);
if($resultudate){  echo'<script>window.location="admin.php?action=guidelines _text";</script>' ;} else { die('error' . mysql_error()); }
}
?>
